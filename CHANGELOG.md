...
### Fixed
- **Dynamic semantic writes** - Successful dynamic writes now observe an adaptive, bounded hydration window before one verification so immediate control state and delayed page content are available. See [#316](https://github.com/nicobailon/surf-cli/issues/316).
