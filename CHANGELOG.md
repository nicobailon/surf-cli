...
### Fixed
- **Dynamic semantic writes** - Successful dynamic writes now settle before verification so delayed checked state and page content are observed. See [#316](https://github.com/nicobailon/surf-cli/issues/316).
