...
### Fixed
- **Dynamic semantic writes** - Successful dynamic writes now observe a bounded hydration window before one verification so delayed checked state and page content are available. See [#316](https://github.com/nicobailon/surf-cli/issues/316).
